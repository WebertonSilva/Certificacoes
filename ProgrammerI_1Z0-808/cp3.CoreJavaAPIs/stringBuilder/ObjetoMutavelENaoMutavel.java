...
public class ObjetoMutavelENaoMutavel {
	...
	public static void main(String[] args) {
		...
		if(s.equals(sb3)){
			System.out.println("é a mesma referencia");
		}
		else
		{
			System.out.println("não é a mesma referencia");
		}
		
		String w = "Java";
		
		if(s == w){
			System.out.println("é o mesmo conteudo ");
		}else {
			System.out.println("não é é o mesmo conteudo");
		}
